    ...
    <div className="relative overflow-hidden pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
        ...
        <div className="flex justify-center space-x-4">
          <button className="bg-purple-600 text-white px-8 py-3 rounded-lg text-lg font-medium hover:bg-purple-700 transition-colors flex items-center">
            Get Started
            <ArrowRight className="ml-2 h-5 w-5" />
          </button>
          <button className="border-2 border-purple-500 text-purple-500 px-8 py-3 rounded-lg text-lg font-medium hover:bg-purple-900/50 transition-colors">
            Learn More
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-purple-500/10 transition-shadow border border-gray-700">
            ...
            <p className="text-gray-300">Advanced algorithms provide personalized mental health recommendations and tracking.</p>
          </div>
          <div className="bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-purple-500/10 transition-shadow border border-gray-700">
            <div className="h-12 w-12 bg-purple-900/50 rounded-lg flex items-center justify-center mb-6">
